...
$info = "[$table]|fichier=".$chemin_fichier."|commentaire=".$commentaire;
$log->cdr("import", $info);
...
{
	$syntaxe = "UPDATE ".$table." SET statut = 'NO' WHERE RIGHT(TRIM(`telephone`),".abs(intval($significant)).") = '".substr(trim($telephone),$significant)."'";
	$db->db_query($syntaxe);
